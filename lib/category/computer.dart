...
import 'package:gadget_store/category/All.dart';
...
class ComputerPage extends StatefulWidget {
  ...
  @override
  State<ComputerPage> createState() => _UIHomePageState();
}

class _UIHomePageState extends State<ComputerPage> {
                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        ...
                        ListTile(title: Text("All"),enableFeedback: true,hoverColor: Colors.black45, selectedTileColor: Color(0xff843667),
                            onTap: (){Navigator.push(context, MaterialPageRoute(builder: (context)=> AllPage()),);}),
                        SizedBox(height: 20,),
                        ...
                        ListTile(title: Text("Computers"),hoverColor: Color(0xff343333), selectedTileColor: Color(0xff843667),onTap: (){},),
                        SizedBox(height: 20,),
                          ...
                          child: Column(
                            ...
                            children: [
                                ...
                                child: Container(
                                  ...
                                  child: Center(
                                    child: GestureDetector(
                                        onTap: (){
                                          Navigator.push(context, MaterialPageRoute(builder: (context) => (ProductDetails(selected: computer[index],))));
                                        },
                                        child: Image.asset(computer[index].image,height: 78,)),
                                  ),
                                ),
                              ),
                              SizedBox(height: 10,),
                              Padding(
                                ...
                                child: Text(computer[index].name, style: TextStyle(
                              ...
                              Padding(
                                padding: EdgeInsets.symmetric(horizontal: 16.0),
                                child: Text(computer[index].description1, style: TextStyle(
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text(computer[index].price.toString() , style: TextStyle(
                                      color: Color(0xff343333),
                                      fontSize: 12.0,
                                      fontWeight: FontWeight.w700,
                                    ),),
