...
class AccessoriesPage extends StatefulWidget {
  ...
  @override
  State<AccessoriesPage> createState() => _UIHomePageState();
}

class _UIHomePageState extends State<AccessoriesPage> {
                  ...
                  Padding(
                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        ...
                        ListTile(title: Text("Accessories"),hoverColor: Color(0xff343333), selectedTileColor: Color(0xff843667),onTap: (){},),
                        SizedBox(height: 20,),
                          ...
                          child: Column(
                            ...
                            children: [
                                ...
                                child: Container(
                                  ...
                                  child: Center(
                                    child: GestureDetector(
                                        onTap: (){
                                          Navigator.push(context, MaterialPageRoute(builder: (context) => (ProductDetails(selected: access[index],))));
                                        },
                                        child: Image.asset(access[index].image,height: 78,)),
                                  ),
                                ),
                              ),
                              SizedBox(height: 10,),
                              Padding(
                                ...
                                child: Text(access[index].name, style: TextStyle(
                              ...
                              Padding(
                                padding: EdgeInsets.symmetric(horizontal: 16.0),
                                child: Text(access[index].description1, style: TextStyle(
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text(access[index].price.toString() , style: TextStyle(
                                      color: Color(0xff343333),
                                      fontSize: 12.0,
                                      fontWeight: FontWeight.w700,
                                    ),),
