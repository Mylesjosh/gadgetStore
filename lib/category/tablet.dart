...
class TabletPage extends StatefulWidget {
  ...
  @override
  State<TabletPage> createState() => _UIHomePageState();
}
                  ...
                  Padding(
                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        ...
                        ListTile(title: Text("Ipads and Tablets"),hoverColor: Color(0xff343333), selectedTileColor: Color(0xff843667),onTap: (){},),
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(tab[index].name, style: TextStyle(
                              ...
                              Padding(
                                padding: EdgeInsets.symmetric(horizontal: 16.0),
                                child: Text(tab[index].description1, style: TextStyle(
