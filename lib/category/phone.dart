...
class PhonePage extends StatefulWidget {
  ...
  @override
  State<PhonePage> createState() => _UIHomePageState();
}

class _UIHomePageState extends State<PhonePage> {
                  ...
                  Padding(
                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        ...
                        ListTile(title: Text("Smart Phones"),hoverColor: Color(0xff343333), selectedTileColor: Color(0xff843667),onTap: (){},),
                        SizedBox(height: 20,),
                          ...
                          child: Column(
                            ...
                            children: [
                                ...
                                child: Container(
                                  ...
                                  child: Center(
                                    child: GestureDetector(
                                        onTap: (){
                                          Navigator.push(context, MaterialPageRoute(builder: (context) => (ProductDetails(selected: phone[index],))));
                                        },
                                        child: Image.asset(phone[index].image,height: 78,)),
                                  ),
                                ),
                              ),
                              SizedBox(height: 10,),
                              Padding(
                                ...
                                child: Text(phone[index].name, style: TextStyle(
                              ...
                              Padding(
                                padding: EdgeInsets.symmetric(horizontal: 16.0),
                                child: Text(phone[index].description1, style: TextStyle(
                              ...
                              Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    Text(phone[index].price.toString() , style: TextStyle(
                                      color: Color(0xff343333),
                                      fontSize: 12.0,
                                      fontWeight: FontWeight.w700,
                                    ),),
